"""
Django settings for prueba_examen project.
...
SECRET_KEY = 'django-insecure--cqcy)8@uo0*ybszeo2*@31qj98xr8a-iwzw__hcf!s6jvciq0'
...
ROOT_URLCONF = 'prueba_examen.urls'
...
WSGI_APPLICATION = 'prueba_examen.wsgi.application'
